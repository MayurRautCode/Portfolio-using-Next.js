        ...
        <div className='grid grid-cols-1 md:grid-cols-12 my-14 lg:my-20 mx-4 md:mx-7 lg:mx-10 gap-7'>
          <div className='col-span-6 bg-[#DAD2D8] hover:bg-white w-full rounded-[2rem] place-self-center px-4 md:px-5 lg:px-8 py-4 md:py-5 lg:py-8 hover:duration-300'>
            <span className='flex justify-between'>
              <button className='bg-black text-[#FEB901] px-5 py-2 rounded-full font-bold text-sm lg:text-xl flex items-center'> <SlCalender className='sm:mr-2 md:mr-3' />2018-2021</button>
              <button className='bg-white px-5 py-2 rounded-full font-bold text-sm lg:text-xl border-black border-2 flex items-center'> <FcGraduationCap className='mr-2 md:mr-3 h-8 w-8' /> Graduation</button>
            </span>
            <span>
          ...
          <div className='col-span-6 bg-[#DAD2D8] hover:bg-white w-full rounded-[2rem] place-self-center px-4 md:px-5 lg:px-8 py-4 md:py-5 lg:py-8 hover:duration-300'>
            <span className='flex justify-between'>
              <button className='bg-black text-[#FEB901] px-4 py-2 rounded-full font-bold text-sm lg:text-xl flex items-center'> <SlCalender className='mr-2 md:mr-3' />2021-2023</button>
              <button className='bg-white px-4 py-2 rounded-full font-bold text-sm lg:text-xl border-black border-2 flex items-center'> <FcGraduationCap className='mr-2 md:mr-3 h-8 w-8' />Post Graduation</button>
            </span>
            <span>
