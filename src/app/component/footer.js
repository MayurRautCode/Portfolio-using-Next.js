...
function Footer() {
  return (
    <footer className='scroll-smooth'>
        ...
        <div className="my-10 mx-4 md:mx-10 py-4 px-4 text-lg md:text-2xl font-semibold text-center text-black rounded-full bg-[#FEB901]">Designed & Built by Mayur Raut</div>
    </footer>
  )
}
